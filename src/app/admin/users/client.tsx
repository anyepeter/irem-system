...
export function AdminUsersClient({ admin, initialUsers, stats }: Props) {
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 space-y-6">
          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
              ...
              <CreateUserDialog onSuccess={handleDataChange} />
            </div>

            <UserTable users={initialUsers} currentUserId={admin.id} onDataChange={handleDataChange} />
          </motion.div>
        </main>
      </div>
    </div>
